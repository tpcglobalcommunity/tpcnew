  ...
  return (
    <PremiumShell>
      ...
      <Section className="pt-16 pb-20 bg-gradient-to-br from-[#0B0E11] via-[#1A1F2E] to-[#2A1F3A] relative w-full max-w-full overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 w-16 h-16 bg-purple-500/5 rounded-full blur-lg -translate-x-1/2 -translate-y-1/2"></div>
        ...
        <Container className="relative z-10">
          <PremiumCard variant="glass" className="text-center p-16 md:p-20 lg:p-24 border-2 border-purple-500/20 shadow-2xl">
            ...
            <div className="relative w-32 h-32 mx-auto mb-8">
              <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 to-indigo-500/20 rounded-full"></div>
      ...
      <Section className="py-20 bg-gradient-to-br from-[#0B0E11] via-[#1A1F2E] to-[#2A1F3A] relative w-full max-w-full overflow-hidden pb-24">
        {/* Premium Background Effects */}
        <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 via-transparent to-indigo-500/10"></div>
        <div className="absolute top-0 left-0 w-24 h-24 bg-purple-500/10 rounded-full blur-xl -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 right-0 w-24 h-24 bg-indigo-500/10 rounded-full blur-xl translate-x-1/2 translate-y-1/2"></div>
