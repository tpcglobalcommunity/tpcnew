  ...
  return (
    <PremiumShell>
      ...
      <Section className="pt-16 pb-20 bg-gradient-to-br from-[#0B0E11] via-[#1A1F2E] to-[#2A1F3A] relative w-full max-w-full overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-24 h-24 bg-red-500/10 rounded-full blur-xl -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 right-0 w-24 h-24 bg-orange-500/10 rounded-full blur-xl translate-x-1/2 translate-y-1/2"></div>
